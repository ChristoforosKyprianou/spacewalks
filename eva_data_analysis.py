...
def plot_cumulative_time_in_space(eva_data, graph_file):
    """
    Plotting cumulative spacewalk duration and saving.
    
    Args: 
        eva_data (dataframe): The dataframe that i want to plot.
    ...
    # Process the duration fropm a string (00:00) to a float
